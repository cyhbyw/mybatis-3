...
public class XmlMapperBuilderTest {
    ...
    public void resolveJdbcTypeWithUndefinedValue() {
        ...
        expectedException.expectMessage(
                startsWith("Error resolving JdbcType. Cause: java.lang.IllegalArgumentException: No enum"));
    ...
    public void resolveResultSetTypeWithUndefinedValue() {
        ...
        expectedException.expect(BuilderException.class);
        expectedException.expectMessage(
                startsWith("Error resolving ResultSetType. Cause: java.lang.IllegalArgumentException: No enum"));
    ...
    public void resolveParameterModeWithUndefinedValue() {
        ...
        expectedException.expect(BuilderException.class);
        expectedException.expectMessage(
                startsWith("Error resolving ParameterMode. Cause: java.lang.IllegalArgumentException: No enum"));
