...
public class XmlConfigBuilderTest {
    ...
    public void unknownSettings() {
        ...
        expectedException.expect(BuilderException.class);
        expectedException
                .expectMessage("The setting foo is not known.  Make sure you spelled it correctly (case sensitive).");
